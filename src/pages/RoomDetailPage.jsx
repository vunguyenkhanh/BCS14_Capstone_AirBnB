...
export default function RoomDetailPage() {
  ...
  const totalNights = useMemo(
    () => differenceInDays(bookedRangeDates[0].endDate, bookedRangeDates[0].startDate),
    [bookedRangeDates]
  );
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        ...
        const commentListResponse = await https.get(
        ...
        const totalSao = commentListResponse.data.content.reduce(
        ...
        const trueValueCount = Object.keys(tempObjectRoom).filter(
          (key) => key !== 'banLa' && tempObjectRoom[key] === true
        ).length;
  ...
  return (
    <>
      <div className="mx-auto w-[95%] py-6 space-y-6">
          ...
          <div className="grid md:flex gap-x-6 gap-y-3">
            <div className="flex gap-x-6">
              {room.danhSachBinhLuan.length > 0 && (
                <ShowRating
                  trungBinhRating={trungBinhRating}
                  binhLuanRef={binhLuanRef}
                  ratingLength={room.danhSachBinhLuan.length}
                />
              )}
          ...
          <div className="basis-7/12 space-y-6">
            <div className="flex items-center justify-between">
              <div className="space-y-3">
                ...
                <p>
                  {room.khach} khách •{' '}
                  {room.tenPhong.toLowerCase().includes('studio') && 'Phòng studio •'}{' '}
            ...
            <div className="space-y-6">
              ...
              <div className="flex gap-3">
                ...
                <div className="space-y-1">
                  ...
                  {hienThiVeSinh && (
                    <span
                      onClick={() => setHienThiVeSinh(false)}
                      className="text-sm font-bold underline text-black cursor-pointer"
                    >
                      Ẩn bớt
                    </span>
                  )}
            ...
            <div className="space-y-6">
              ...
              <p className="text-justify">
                Mọi đặt phòng đều được bảo vệ miễn phí trong trường hợp chủ nhà {chuNha} hủy, thông
                tin nhà/phòng cho thuê không chính xác và những vấn đề khác như sự cố trong quá
                trình nhận phòng.
              </p>
              <div>
                <a
                  href="https://www.airbnb.com.vn/help/article/3218"
                  target="blank"
                  className="font-bold underline text-black cursor-pointer"
                >
                  Tìm hiểu thêm
            ...
            <div>
              <span
                onClick={() => setHienThiMoTa(!hienThiMoTa)}
          ...
          <div className="basis-4/12 space-y-6 sticky w-full lg:h-[350px] top-28">
            <div className="p-6 rounded-lg border-2 border-gray-300 space-y-6 shadow-xl">
              <div className="flex flex-wrap justify-between items-center gap-3">
                <div>
                  <span className="font-bold">${room.giaTien.toLocaleString(COUNTRY_FORMAT)}</span>{' '}
                  / đêm
                </div>
                <div>
                  <ShowRating
              ...
              <button
                ...
                className="font-bold w-full text-white bg-[#FF5A5F] hover:bg-[#9e3e4e] rounded-lg py-3 duration-300"
              >
                Đặt phòng
              </button>
              ...
              <div className="flex justify-between items-center">
                <p className="underline">
                  ${room.giaTien.toLocaleString(COUNTRY_FORMAT)} x{' '}
                  {totalNights.toLocaleString(COUNTRY_FORMAT)} đêm
                </p>
              ...
              <div className="flex justify-between items-center">
                ...
                <p className="font-bold">
                  ${(room.giaTien * totalNights + phiDichVu).toLocaleString(COUNTRY_FORMAT)}
                </p>
              </div>
            </div>
            <p className="flex justify-center items-center gap-3 cursor-pointer">
              ...
              <span
                ...
                className="underline text-gray-500 font-bold text-sm"
              >
        ...
        {user === null ? (
          ...
          <div>
            <Comment
              avatar={
                <Avatar src={user?.avatar !== '' ? user?.avatar : DEFAULT_NO_AVATAR} alt="" />
              }
              content={
                <Editor
      ...
      >
        ...
        <p>
          Ngày sử dụng: {moment(bookedRangeDates[0].startDate).format('DD-MM-YYYY')} {'->'}{' '}
